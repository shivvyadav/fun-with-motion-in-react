...
const Content = ({selected, dir}: any) => {
  return (
    <motion.div
      ...
      className='absolute left-0 top-[calc(100%+24px)] w-96 rounded-lg border border-neutral-600 bg-gradient-b from-neutral-900 via-neutral-900 to-neutral-800 p-4'>
      <Bridge />
